    ...
    <div className="problem-home">
      <nav className="problem-nav" aria-label="문서 메뉴">
        <div className="problem-container problem-nav-inner">
          <a className="problem-wordmark" href="/" aria-label="BrainStorm 처음으로 이동">Brain<span>Storm</span></a>
      ...
      <footer className="problem-footer"><div className="problem-container problem-footer-grid"><div><strong>BrainStorm</strong><p>멋쟁이사자처럼 14기 해커톤을 위한 팀 아이디어 보드예요.</p></div><div><strong>바로가기</strong><div className="problem-footer-links"><a href="#tracks">트랙 비교</a><a href="#problems">문제정의 후보</a><a href="#questions">회의 질문</a></div></div><div><strong>원문 가이드</strong><div className="problem-footer-links"><a href="https://likelion.notion.site/14th-hackathon-guide" target="_blank" rel="noreferrer">멋사 해커톤 가이드 ↗</a><a className="problem-footer-cta" href="/ideas">아이디어 적으러 가기 <span aria-hidden="true">→</span></a></div></div></div></footer>
    </div>
  );
}
